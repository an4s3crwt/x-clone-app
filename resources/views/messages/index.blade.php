...
<div class="bg-white shadow-lg rounded-xl p-6 space-y-4">
    ...
    <div class="user-list space-y-3">
        @foreach ($users as $user)
            <a href="{{ route('messages.show', $user) }}" class="flex items-center gap-4 p-4 hover:bg-gray-100 transition-all duration-300 transform rounded-lg hover:scale-105 hover:shadow-lg">
